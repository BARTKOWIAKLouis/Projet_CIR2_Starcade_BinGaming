...
public class WebSocketClient_menu_astronaute : MonoBehaviour
{
    ...
    public move_palyer_game movementScript_P1;
    public portail portail;
    public retour_menu retour;
    /*public portail portail_ice;
    public retour_menu retour_ice;
    public portail portail_tron;
    public retour_menu retour_tron;
    public portail portail_war;
    public retour_menu retour_war;
    public portail portail_speed_fight;
    public retour_menu retour_speed_fight;*/
                ...
                case '1':
                    switch (message) // à modifier, regarde quelle action le joueur effectue (P1)
                    {
                        ...
                        case "P1_APressed":
                            ...
                            portail.fonction_Act1("on");
                            retour.fonction_Act1("on");

                            /*portail_ice.fonction_Act1("on");
                            portail_war.fonction_Act1("on");
                            portail_tron.fonction_Act1("on");
                            portail_speed_fight.fonction_Act1("on");
                            retour_war.fonction_Act1("on");
                            retour_ice.fonction_Act1("on");
                            retour_tron.fonction_Act1("on");
                            retour_speed_fight.fonction_Act1("on");*/
                            break;
                            /*
                        case "P1_BPressed":
...
*/
    ...
    public void setScript(move_palyer_game tmp_Player)
    {
