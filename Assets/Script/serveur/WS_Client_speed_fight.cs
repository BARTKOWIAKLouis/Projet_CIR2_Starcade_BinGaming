...
public class WebSocketClient_speed_fight : MonoBehaviour
{
    ...
    public bulle_script movementScript_P1;
    public bulle_script movementScript_P2;
...
*/
    ...
    public void setScript(bulle_script tmp_Player, int i)
    {
        switch (i)
        {
            case 0:
