...
public class WebSocketClient_tron : MonoBehaviour
{
    ...
    public Movement_player_tron movementScript_P1;
    public Movement_player_tron movementScript_P2;
    public Movement_player_tron movementScript_P3;
    public Movement_player_tron movementScript_P4;

    public winner_tron_script winner_P1;
    public winner_tron_script winner_P2;
    public winner_tron_script winner_P3;
    public winner_tron_script winner_P4;
    ...
    void Start()
    {
        ...
        // demande du nombre de joueur au serveur
        string message = "Nombre player";
        ws.Send(message);
    ...
    public void setScript(Movement_player_tron tmp_Player, int i)
    {
        switch (i)
        {
            case 0:
    ...
    public void setScript_winner(winner_tron_script tmp_Player,int i)
    {
        switch (i)
        {
            case 0:
                winner_P1 = tmp_Player;
                break;

            case 1:
                winner_P2 = tmp_Player;
                break;

            case 2:
                winner_P3 = tmp_Player;
                break;

            case 3:
                winner_P4 = tmp_Player;
                break;
        }
        ;
    }
