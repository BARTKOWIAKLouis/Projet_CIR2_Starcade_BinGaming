...
public class WebSocketClient_ice : MonoBehaviour
{
    ...
    public mvt_player_ice movementScript_P1;
    public mvt_player_ice movementScript_P2;
    public mvt_player_ice movementScript_P3;
    public mvt_player_ice movementScript_P4;

    public Winner_script_ice winner_P1;
    public Winner_script_ice winner_P2;
    public Winner_script_ice winner_P3;
    public Winner_script_ice winner_P4;
    ...
    public void setScript(mvt_player_ice tmp_Player, int i)
    {
        switch (i)
        {
            case 0:
    ...
    public void setScript_winner(Winner_script_ice tmp_Player,int i)
    {
        switch (i)
        {
            case 0:
