...
public class WebSocketClient_war : MonoBehaviour
{
    ...
    public mvt_player movementScript_P1;
    public mvt_player movementScript_P2;
    public mvt_player movementScript_P3;
    public mvt_player movementScript_P4;

    public winner_script winner_P1;
    public winner_script winner_P2;
    public winner_script winner_P3;
    public winner_script winner_P4;
    ...
    public void setScript(mvt_player tmp_Player, int i)
    {
        switch (i)
        {
            case 0:
    ...
    public void setScript_winner(winner_script tmp_Player,int i)
    {
